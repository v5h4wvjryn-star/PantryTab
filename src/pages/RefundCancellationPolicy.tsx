...
export default function RefundCancellationPolicy() {
  return (
    <LegalLayout title="Refund &amp; Cancellation Policy" lastUpdated="February 6, 2026">
      ...
      <p className={p}>
        Pantry Tab operates on a <strong>paid subscription model only</strong>. There is no permanent
        free plan.
      </p>
      ...
      <ul className={ul}>
        ...
        <li><strong>The trial does not automatically convert to a paid subscription</strong></li>
        <li>
      ...
      <p className={p}>
        After the trial period ends, you must choose a paid subscription to continue using Pantry Tab:
      </p>
      <ul className={ul}>
      ...
      <p className={p}>
        All payments are processed securely by <strong>Stripe</strong>. We do not store your payment
        card details.
      </p>
      ...
      <ul className={ul}>
        <li>You are solely responsible for canceling your subscription before renewal</li>
        <li>We are not responsible for charges that occur because you failed to cancel in time</li>
      ...
      <p className={warn}>WE DO NOT OFFER REFUNDS.</p>
      <p className={p}>
      ...
      <p className={p}>
        If you can demonstrate that your account was compromised and used without your authorization,
        and you reported it to us promptly.
      </p>
      ...
      <p className={p}>
        Initiating a chargeback or payment dispute with your bank or credit card company for a charge
        that does not meet the narrow exceptions in Section 5.2 is a violation of these Terms and may
        result in:
      </p>
      <ul className={ul}>
      ...
      <p className={p}>
        The 14-day free trial exists specifically so you can evaluate the App before paying. For this
        reason:
      </p>
      <ul className={ul}>
        <li>
      ...
      <p className={p}>
        We may terminate your account at any time for violations of our Terms of Service, fraudulent
      ...
      <p className={p}>
        <strong>Important:</strong> If you use the App's features after your trial ends and your paid
        subscription begins, you expressly waive your right to withdraw.
      </p>
      ...
      <p className={p}>We will process your refund within 14 days of receiving your withdrawal request.</p>

      <h3 className={h3}>9.3 Waiver</h3>
      <p className={p}>
        By using the App after your trial ends and your paid subscription begins, you expressly
        consent to the immediate performance of the contract and acknowledge that you lose your right
        to withdraw.
      </p>
      ...
      <p className={p}>
        We may update this Refund and Cancellation Policy at any time. Changes will be posted in the
        App and on our website. Your continued use of the App after changes constitutes acceptance of
        the updated Policy.
      </p>
      ...
      <div className="mt-10 pt-6 border-t border-gray-200">
        ...
        <p className={warn}>ALL SALES ARE FINAL. NO REFUNDS EXCEPT AS REQUIRED BY LAW.</p>
      </div>
